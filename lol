...
local function draggable(input, frame)
...
function OpenedColor(text,ColourDisplay,Action,def)
	...
	BG.BorderColor3 = Color3.fromRGB(87, 67, 104)
	...
	Upper.BorderColor3 = Color3.fromRGB(87, 67, 104)
	...
	linedecoupper.BackgroundColor3 = Color3.fromRGB(87, 67, 104)
	linedecoupper.BorderColor3 = Color3.fromRGB(87, 67, 104)
...
BG.Parent = MAIN
BG.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
BG.BorderColor3 = Color3.fromRGB(72, 56, 79)
BG.BorderSizePixel = 0
...
Upper.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Upper.BackgroundTransparency = 1.000
Upper.BorderColor3 = Color3.fromRGB(72, 56, 79)
Upper.BorderSizePixel = 0
...
linedecoupper.BackgroundColor3 = Color3.fromRGB(72, 56, 79)
linedecoupper.BorderColor3 = Color3.fromRGB(72, 56, 79)
linedecoupper.BorderSizePixel = 0
...
DOWNER.BorderColor3 = Color3.fromRGB(72, 56, 79)
...
linedecoDOWNER.BackgroundColor3 = Color3.fromRGB(72, 56, 79)
linedecoDOWNER.BorderColor3 = Color3.fromRGB(72, 56, 79)
...
function library:AddWindow(text)
	...
	function sec:AddSection(Texto,side)
		...
		F_line.BackgroundColor3 = Color3.fromRGB(87, 67, 104)
		F_line.BorderColor3 = Color3.fromRGB(87, 67, 104)
		...
		function inside:AddTextBox(Text,placeholder, CTOF, Type, Action)
			...
			obj6.ZIndex = 15
			obj6.Font = Enum.Font.SourceSans
			obj6.Text = Text
			...
			obj6.TextStrokeTransparency = 0.85
		...
		function inside:AddToggle(Text,Enabled,keybind,Callback)
			...
			local function Update()
				if activated == false then
					TweenService:Create(color , TweenInfo.new(0.26, Enum.EasingStyle.Quad , Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(152, 126, 181)}):Play()
			...
			TextLabel.TextXAlignment = Enum.TextXAlignment.Left
			TextLabel.TextStrokeTransparency = 0.89
